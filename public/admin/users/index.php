...
<section class="content">
    ...
    <?php
    if (isset($_GET['id'])) {
        $display_user = find_user_by_id($_GET['id'], false);
        display_table($display_user);
    }
        ?>

    <?php if (has_priv_level(2)) { ?>
        <button class="add_link menuItem bigbold text_shadow"><a href="<?php echo url('admin/users/new_user.php'); ?>"
                                                               title="Add new user">Add New User</a></button>
